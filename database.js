...
// PERMISSOES DO SITE
const corsOptions = {
  origin: ['http://127.0.0.1:5501','https://ailtonbarreto.github.io/webstore/pedido.html','https://ailtonbarneto.github.io/webstore'],
  methods: 'GET,POST',
};
...
app.post('/inserir', async (req, res) => {
  ...
  const query = `
    ...
    VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, "AGUARDANDO CONFIRMACAO")
    RETURNING *;
  `;
